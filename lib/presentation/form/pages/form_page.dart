...
class _FormPageState extends State<FormPage> {
  ...
  final ValueNotifier<File?> attachmentFile = ValueNotifier<File?>(null);
...
class _PartTwoState extends State<PartTwo> {
  ...
  Future<void> _pickImage() async {
    ...
    if (image != null) {
      ...
      widget.logoFile.value = pickedFile; // update ValueNotifier
      setState(() {
      ...
      child: Column(
        ...
        children: [
          ...
          CompanyField(
            ...
            isOverLimit: widget.descriptionController.text.length > 300,
            maxLength: 300,
            onTextChanged: (text) {
              setState(() {});
            },
...
class _PartThreeState extends State<PartThree> {
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null && result.files.isNotEmpty) {
      ...
      if (kIsWeb) {
        // Penanganan pemilihan file di web
      } else {
      ...
      child: Column(
        ...
        children: [
          ...
          CompanyUploader(
            ...
            valueNotifier: widget.attachmentFile,
            fileName: _fileName,
                ...
                builder: (context, state) {
                  ...
                  return NextButton(onPressed: () {
                    ...
                    if (widget.logoFile.value != null) {
                      ...
                      if (!['.png', '.jpg', '.jpeg'].any((ext) => logoPath.endsWith(ext))) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Logo harus berupa gambar (png, jpg, jpeg)!')),
                        );
                        return;
                      }
                    } else {
